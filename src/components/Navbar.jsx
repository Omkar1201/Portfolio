...
export default function Navbar() {
    ...
    return (
        <div className='text-white border border-white flex px-12 pb-8 pt-6 rounded-tr-3xl rounded-bl-3xl border-opacity-10 bg-white bg-opacity-5 justify-between h-fit w-[27rem]'>
            <Link to='/'>
